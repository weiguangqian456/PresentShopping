...
import com.example.presentshopping.jpay.alipay.PayResult
...
class Alipay private constructor(private val mContext: Activity) {
    private var mJPayListener: JPay.JPayListener? = null

    /**
     * 调用支付宝SDK
     */
    fun startAliPay(orderInfo: String?, listener: JPay.JPayListener?) {
