...
public class BaseDialog extends AppCompatDialog implements
     ...
     * @deprecated          请使用 {@link #addOnSho2wListener(OnShowListener)}}
     */
    @Deprecated
    @Override
    ...
    public void onCancel(DialogInterface dialog) {
        if (mOnCancelListeners != null) {
            for (OnCancelListener listener : mOnCancelListeners) {
    ...
    public static final class AnimStyle {
        // 默认动画效果
        public static final int DEFAULT = R.style.ActionSheetDialogAnimation;

        // 缩放动画
        public static final int SCALE = R.style.ActionSheetDialogAnimation;
...
//        public static final int TOP = R.style.TopAnimStyle;
        ...
        // 底部弹出动画
        public static final int BOTTOM = R.style.ActionSheetDialogAnimation;
