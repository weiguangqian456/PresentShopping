package com.example.presentshopping.utils.edit;
 ...
 * @Author: LXJ
 * @CreateDate: 2020/7/28 15:05
 * @UpdateUser: 更新者
 * @UpdateDate: 2020/7/28 15:05
 * @UpdateRemark: 更新说明
 * @Version:
 * @Description: java类作用描述：设置状态栏透明：侵入式透明status bar工具类。
 * 这个类 支持了 设置状态栏透明, 设置状态栏颜色, 支持了状态栏深色浅色切换(则状态栏上的文字图标颜色)
 *
 * 前期准备:
 ...
 * ————————————————
 * ————————————————
 * 版权声明：本文为CSDN博主「MX东芝」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
 * 原文链接：https://blog.csdn.net/u014418171/article/details/81223681
 */
